...
| **denoise**                | 降噪强度系数         | 控制添加到潜在空间的噪声强度，0.0 保留原始输入特征，1.0 为完全的噪声 |
...
- **发布时间**：2022 年 10 月
- **核心架构**：基于 Latent Diffusion Model (LDM)
- **训练数据**：LAION-Aesthetics v2.5 数据集（约 5.9 亿步训练）
- **开源特性**：完全开源模型/代码/训练数据
